...
function StoreButtons({ className = "", variant = "dark" }: { className?: string; variant?: "dark" | "light" }) {
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-center gap-3 ${className}`}>
      ...
      {/* iOS Button (Routes to PWA Register) */}
      <Link
        to="/register"
        className={`relative flex items-center gap-3 px-5 py-3 rounded-xl border transition-all duration-200 hover:scale-105 cursor-pointer ${isDark
          ? "bg-white/10 hover:bg-white/15 border-white/20"
          : "bg-[#09090b]/5 hover:bg-[#09090b]/10 border-[#09090b]/10"
          }`}
        style={{ fontFamily: "'DM Sans', sans-serif" }}
      >
        <svg viewBox="0 0 384 512" className="w-5 h-5 shrink-0">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-medium leading-none opacity-70 uppercase tracking-wider">Download on the</span>
            ...
            <div className="flex gap-16 md:gap-20" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li><Link to="/register" className="text-white/60 hover:text-white transition-colors text-sm">App Store</Link></li>
